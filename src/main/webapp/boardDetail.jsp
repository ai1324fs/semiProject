...
<div align="center">
	<table border="1" style="text-align: center; width: 100%;">
		...
		<tr style="height: 40; ">
			<td colspan="4">
				<button onclick="location.href='boardRewriteform.jsp?b_no=<%=bBean.getb_no()%>&ref=<%=bBean.getRef() %>&re_step=<%=bBean.getRe_step()%>&re_level=<%=bBean.getRe_level()%>'">댓글쓰기</button>&nbsp;&nbsp;
				<button onclick="location.href='boardUpdateform.jsp?b_no=<%=bBean.getb_no() %>'">수정하기</button>&nbsp;&nbsp;
				<button onclick="location.href='boardDeleteform.jsp?b_no=<%=bBean.getb_no() %>'">삭제하기</button>&nbsp;&nbsp;
